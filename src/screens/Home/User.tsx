...
//       id: "1",
//       title: "Your Number 1 trusted delivery service",
//       description: "With Fast you get the best delivery service across the country",
//       tag: "Fast Logistics",
//       imageUrl: "",
//     },
//     {
...
//             <Text style={styles.balanceAmount}>{formatCurrency(balance)}</Text>
//             <View style={styles.balanceActions}>
//               <TouchableOpacity style={styles.balanceButton} onPress={handleTopUp}>
//                 <Icon name="arrow-up" size={16} color={colors.text.primary} />
//                 <Text style={styles.balanceButtonText}>Top Up</Text>
//               </TouchableOpacity>
...
//           {/* Action Buttons */}
//           <View style={styles.actionButtons}>
//             <ActionButton icon="bicycle" label="Send Parcel" onPress={() => handleActionPress("Send Parcel")} />
//             <ActionButton icon="locate" label="Track Parcel" onPress={() => handleActionPress("Track Parcel")} />
//             <ActionButton icon="time" label="Schedule" onPress={() => handleParcelPress("Schedule")} />
//           </View>
...
//             <View style={styles.paginationContainer}>
//               {promotions.map((_, index) => (
//                 <View key={index} style={[styles.paginationDot, index === activeSlide && styles.paginationDotActive]} />
//               ))}
//             </View>
//           </View>
...
//             <Text style={styles.sectionTitle}>Pickup Locations</Text>
//             <View style={styles.locationsContainer}>
//               <LocationCard type="Home" address="Set home address" onPress={() => handleLocationPress("Home")} />
//               <LocationCard type="Work" address="Set work address" onPress={() => handleLocationPress("Work")} />
//             </View>
//           </View>
